                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="homepage"><g:message code="product.homepage.label" default="Homepage" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: productInstance, field: 'homepage', 'errors')}">
                                    <g:textField name="homepage" value="${productInstance?.homepage}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="licenses"><g:message code="product.licenses.label" default="Licenses" /></label>
                                </td>
